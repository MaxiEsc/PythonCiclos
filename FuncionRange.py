#Funcion Range la utilidad de esta funcion es Generar una secuencias de funcion de numeros, Se utiliza para ciclos FOR
#Siendo su idea range (inicio; fin; incremento)
